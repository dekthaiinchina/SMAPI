...
/// <param name="ByApiVersion">The number of update-check requests by SMAPI version.</param>
/// <param name="ByGameVersion">The number of update-check requests by game version.</param>
/// <param name="ByGameVersion">The number of update-check requests by OS platform.</param>
...
internal record MetricsSummary(
    ...
    IDictionary<string, long> ByPlatform,
